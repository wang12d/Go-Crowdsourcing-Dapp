go: Platform accounts.json
	...
	(ganache-cli -m "enable laugh there club flower source fog attract giraffe trend light rival" -a 60 -l 67219750000 --account_keys_path=$(shell pwd)/accounts.json --verbose &)
